              ...
              >
                <View
                  style={{
                    ...
                    transform: [
                      { scale: isActive && isVisible ? 1 : isActive ? 0.4 : 1 },
                    ],
                  }}
                />
              </View>
      ...
      <View style={styles.content}>
        ...
        >
          <View style={styles.ctaRing}>
            <Animated.View
              style={[styles.ctaDot, { transform: [{ scale: ctaPulse }] }]}
            />
          </View>
